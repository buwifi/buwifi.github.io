...
if (isset($_GET['mail'])) {
   ...
   if($getActionURI ==="request") {
      ...
      $smtp_username    = 'murate@gmail.com';             // SMTP username
      $smtp_password    = 'vdcaxtpgeeghdgxi';                         // SMTP password
      ...
      try {
         ...
         $mail->addAddress("murat@junivodigital.com");                  // Enter the email address you want to send here
