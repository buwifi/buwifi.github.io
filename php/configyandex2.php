...
define('CONTACTFORM_FROM_ADDRESS', 'info@junivodigital.com');
define('CONTACTFORM_FROM_NAME', 'Murat Eren Yandex');
...
define('CONTACTFORM_TO_ADDRESS', 'info@junivodigital.com');
define('CONTACTFORM_TO_NAME', 'Your Name Yandex');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.yandex.com');
define('CONTACTFORM_SMTP_USERNAME', 'info@junivodigital.com');
define('CONTACTFORM_SMTP_PASSWORD', 'hdvfqsymxwqjjype');

// The reCAPTCHA credentials for your site. You can get these at https://www.google.com/recaptcha/admin
define('CONTACTFORM_RECAPTCHA_SITE_KEY', '6LdeQ6obAAAAAGYNZP3nIQymmmbSLhcLMmZMt5IC');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', '6LdeQ6obAAAAAL1Vq1mAcKn9QZsJR04C3S0rBNAM');
